...
-- 1. Retrieves loan status statistics, including counts, total amount received, 
...
-- 2. Retrieves Month-to-Date (MTD) loan status statistics for December 2021, including total amount received and total funded amount.
SELECT 
	loan_status, 
